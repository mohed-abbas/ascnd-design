...
export const FAQS: readonly Faq[] = [
  ...
  },
  {
    ...
    answer:
      "no pitch decks, no print, no throwaway spec work. we design and build digital products. brand, web, and product, end to end.",
  },
];
...
export const PRICING_FAQS: readonly Faq[] = [
  ...
  },
  {
    question: "what don't you do?",
    answer:
      "no back-end or infra, no throwaway spec work, no rotating cast. we design and build front-end product. brand, web, and interface, end to end.",
  },
];

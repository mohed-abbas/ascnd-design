/**
 * Trail — 1:1 port of `codrops-depth-gallery-main/src/Experience/Trail.js`.
 *
 * A tapered glowing tube built from a Catmull-Rom spline through recent head
 * positions. Ported verbatim (logic unchanged); only TypeScript types added.
 */

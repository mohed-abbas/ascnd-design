/**
 * TrailHeadParticles — 1:1 port of
 * `codrops-depth-gallery-main/src/Experience/TrailHeadParticles.js`.
 *
 * A small pool of sphere sprites that sparkle near the trail head. Ported
 * verbatim (logic unchanged); only TypeScript types added.
 */

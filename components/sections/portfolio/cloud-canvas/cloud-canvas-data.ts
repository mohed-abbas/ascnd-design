 ...
 * Fibonacci sphere.
 *
 * The images live in public/portfolio/cloud/ named cloud-01.png … cloud-NN.png.
...
/** How many cloud-NN.png files exist in public/portfolio/cloud/. */
const CLOUD_IMAGE_COUNT = 22;

export const cloudImages: CloudImage[] = Array.from({ length: CLOUD_IMAGE_COUNT }, (_, i) => {
  const nn = String(i + 1).padStart(2, "0");
  return {
    src: `/portfolio/cloud/cloud-${nn}.png`,
    name: `Project ${nn}`,
  };
});
